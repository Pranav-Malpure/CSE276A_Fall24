...
class PIDcontroller(Node):
    def __init__(self, Kp, Ki, Kd):
        ...
        self.tags = {'2': [2.25*0.3048, 0, -np.pi/2], '7': [4.5*0.3048, 0, -np.pi/2], '6': [6.75*0.3048, 0, -np.pi/2], '12': [9*0.3048, 2.25*0.3048, 0], '11': [9*0.3048, 4.5*0.3048, 0],
                     '10': [9*0.3048, 6.75*0.3048, 0], '4': [6.75*0.3048, 9*0.3048, np.pi/2], '1': [4.5*0.3048, 9*0.3048, np.pi/2], '5': [2.25*0.3048, 9*0.3048, np.pi/2]}
