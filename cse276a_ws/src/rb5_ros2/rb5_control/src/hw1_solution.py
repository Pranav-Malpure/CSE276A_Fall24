...
class PIDcontroller(Node):
    ...
    def update(self, currentState):
        ...
        P = np.array([self.Kp * e[0]/0.4, self.Kp * e[1]/0.5, self.Kp * e[2]/3.5])
        ...
        I = self.I
        D = np.array([self.Kd * (e[0] - self.lastError[0]), self.Kd * (e[1] - self.lastError[1])/2, self.Kd * (e[2] - self.lastError[2])/0.25])
        result = P + I + D
