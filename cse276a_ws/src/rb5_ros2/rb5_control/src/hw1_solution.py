...
class PIDcontroller(Node):
    def __init__(self, Kp, Ki, Kd):
        ...
        self.tags = {'2': [0, 1*0.3048, -np.pi], '6': [0, 1*0.3048, -np.pi/2], '7': [8*0.3048, 1*0.3048, 0.0], '4': [7*0.3048, 0, -np.pi/2], '1': [7*0.3048, 8*0.3048, np.pi/2], '11': [8*0.3048, 7*0.3048, 0], '5': [1*0.3048, 8*0.3048, np.pi/2], '10': [0, 7*0.3048, -np.pi]}
